...
export default async (req, res) => {
    ...
    const mailData = {
        ...
        text: `
                ...
                <p>I'm exited to send out a reminder that the meditation session is <u>TODAY</u>.</p>
                <p>Here is the link - <a href="https://us04web.zoom.us/j/76063040928?pwd=c2E2U21sVVNEdjNTWUlXZjNIY1hoUT09">CLICK HERE TO JOIN THE ZOOM CALL</a></p>
                <h2><u>The Plan</u></h2> 
                <p>The call will start at 8pm. We will start the session soon after that.</p>
