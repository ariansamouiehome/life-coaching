...
export default async (req, res) => {
    ...
    const subject = 'Meditation Sessions Tonight';
    const bodyText = `
        <img src="https://ariansamouie.com/images/logo-single.svg" style="max-width: 320px;"/>
        <h1>How To Let Go - Becoming The New You</h1>
        <p>Tuesday 22nd 8pm (TODAY)</p>
        <br />
        <h2>Hi ${req.body.firstName}.</h2>   
        <p>A friendly reminder about the meditation session tonight.</p>
        <p>I'm looking forward to seeing you there.</p>
        
        <br/>
        <p>Just in case it helps, here's a link for the session tonight.</p>
