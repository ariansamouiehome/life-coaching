export default async (req, res) => {
    ...
    const mailDataToMe = {
        ...
        subject: `Meditation Session - ${req.body.first_name} ${req.body.last_name}`,
