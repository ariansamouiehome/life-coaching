const courses =[
    {
        ...
        card_description: 'Learn the skills to heal yourself from trauma.',
        ...
        courseList: [
            ...
            'Meditation - What is it and why meditate?',
            'Reintegration - The Integration Process (A powerful process designed to heal aspects)',
            'Healing your inner child (Meditation)',
        ],
        comingSoon: true,
        comingSoonDate: 'July/August 2022',
    },
    {
        altCard: false,
        category: 'Meditation',
