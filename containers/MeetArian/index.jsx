    ...
    return (
        <>
            ...
            <ImageSideText
                ...
                contentSwitch
            >
                <p className="body-copy">I have always known that I can always do some things to improve myself. Maybe I could eat better, or go exercise more. Maybe I spend too much time on social media. Maybe I drink too much and need to cut down. But I struggled to keep any of the things I tried to do consistent. Even though I forced myself to stop, I always eventually went back. I still craved whatever it was that was dragging me to the bad food. I still didn’t have enough energy to exercise properly. I had to force myself to stay off social media. <br /><br />What healing does is it gets rid of the things keeping you in a place where you still crave doing the things you know you don’t want to do. Without even trying, my diet has improved. I exercise regularly without effort. My time spent on social media browsing carelessly has reduced to almost none. <br /><br />When we look at all the things around us that we feel like we need to change, it can look like a lot of work. All you need to do is concentrate on healing yourself. EVERYTHING ELSE will fall into place.</p>
            </ImageSideText>
